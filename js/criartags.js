...
listaTags[8]  .setAttribute("placeholder", "Linguagens de programação")
listaTags[9]  .setAttribute("placeholder", "Frameworks")
listaTags[10] .setAttribute("placeholder", "Banco de dados")
listaTags[11] .setAttribute("placeholder", "Sistemas Operacionais")
listaTags[12] .setAttribute("placeholder", "Ferramentas para Design UX/UI")
listaTags[13] .setAttribute("placeholder", "Idiomas")
listaTags[15] .setAttribute("placeholder", "Links Sociais")
